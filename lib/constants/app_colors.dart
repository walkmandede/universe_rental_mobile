...
class AppColors{
  ...
  static Color bgBlack = const Color(0xff101010);
  static Color bgSoftBlack = const Color(0xff0f0f0f);
  ...
  static Color textGrey = const Color(0xffffffff).withOpacity(0.5);
